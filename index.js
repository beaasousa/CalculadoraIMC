...
function setup() {
    ...
    campoAltura = document.getElementById("alturaPessoa");
    campoMassa = document.getElementById("massaPessoa");
    ...
    botaoQueCalcula.addEventListener("click", () => {
        ...
        const situacaoPessoa = testaSituacao(valorIMC);

        paragrafoExibeIMC.innerText = `${valorIMC} kg/m².`;
        paragrafoExibeSituacao.innerText = `${situacaoPessoa}`;
